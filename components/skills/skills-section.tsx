      ...
      <div className={classes.container}>
        <Link href="https://nextjs.org/">
          <a className={classes.box}>
            <Image src="/images/skills/nextjs.jpeg" alt="ABC-optical link" width={300} height={160} layout="responsive"/>
            <h2>Next.js</h2>
        ...
        <Link href="https://www.typescriptlang.org/">
          <a className={classes.box}>
            <Image src="/images/skills/typescript.jpeg" alt="Kiyo-first-page link" width={300} height={160} layout="responsive"/>
            <h2>TypeScript</h2>
        ...
        <Link href="https://sass-lang.com/">
          <a className={classes.box}>
            <Image src="/images/skills/sass.png" alt="" width={300} height={160} layout="responsive"/>
            <h2>Sass</h2>
